...
function contributorPage(snapshot: RankingSnapshot<RankedContributor>, options?: { global?: boolean; rising?: boolean }): string {
...
function projectsPage(snapshot: RankingSnapshot<RankedProject>, options?: { title?: string; eyebrow?: string; description?: string; intro?: string; rawPrefix?: string }): string {
