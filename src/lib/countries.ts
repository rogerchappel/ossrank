...
export const COUNTRY_CONFIGS: CountryConfig[] = [
  { slug: 'australia', code: 'AU', name: 'Australia', queries: ['location:Australia repos:>5'], locationTerms: ['Australia', 'Sydney', 'Melbourne', 'Brisbane', 'Perth', 'Adelaide', 'Canberra', 'Hobart', 'Darwin', 'NSW', 'VIC', 'QLD'], seedLogins: ['rogerchappel'] },
  ...
  { slug: 'united-states', code: 'US', name: 'United States', queries: ['location:"United States" repos:>5'], locationTerms: ['United States', 'USA', 'U.S.', 'US', 'California', 'New York', 'Seattle', 'San Francisco', 'Bay Area', 'Austin', 'Boston', 'Chicago'] },
  { slug: 'canada', code: 'CA', name: 'Canada', queries: ['location:Canada repos:>5'], locationTerms: ['Canada', 'Toronto', 'Vancouver', 'Montreal', 'Ottawa', 'Calgary'] },
  { slug: 'united-kingdom', code: 'GB', name: 'United Kingdom', queries: ['location:"United Kingdom" repos:>5'], locationTerms: ['United Kingdom', 'UK', 'England', 'Scotland', 'Wales', 'London', 'Manchester', 'Edinburgh'] },
  { slug: 'ireland', code: 'IE', name: 'Ireland', queries: ['location:Ireland repos:>5'], locationTerms: ['Ireland', 'Dublin', 'Cork'] },
  { slug: 'germany', code: 'DE', name: 'Germany', queries: ['location:Germany repos:>5'], locationTerms: ['Germany', 'Deutschland', 'Berlin', 'Munich', 'München', 'Hamburg'] },
  { slug: 'france', code: 'FR', name: 'France', queries: ['location:France repos:>5'], locationTerms: ['France', 'Paris', 'Lyon', 'Toulouse'] },
  { slug: 'netherlands', code: 'NL', name: 'Netherlands', queries: ['location:Netherlands repos:>5'], locationTerms: ['Netherlands', 'Nederland', 'Amsterdam', 'Rotterdam', 'Utrecht'] },
  ...
  { slug: 'austria', code: 'AT', name: 'Austria', queries: ['location:Austria repos:>5'], locationTerms: ['Austria', 'Österreich', 'Vienna', 'Wien'] },
