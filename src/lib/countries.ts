...
export const COUNTRY_CONFIGS: CountryConfig[] = [
  { slug: 'australia', code: 'AU', name: 'Australia', queries: ['location:Australia repos:>5', 'location:Sydney repos:>5', 'location:Melbourne repos:>5', 'location:Brisbane repos:>5'], locationTerms: ['Australia', 'Sydney', 'Melbourne', 'Brisbane', 'Perth', 'Adelaide', 'Canberra', 'Hobart', 'Darwin', 'NSW', 'VIC', 'QLD'], seedLogins: ['rogerchappel'] },
  ...
  { slug: 'united-kingdom', code: 'GB', name: 'United Kingdom', queries: ['location:"United Kingdom" repos:>5', 'location:London repos:>5', 'location:England repos:>5', 'location:Scotland repos:>5'], locationTerms: ['United Kingdom', 'UK', 'England', 'Scotland', 'Wales', 'London', 'Manchester', 'Edinburgh'], seedLogins: ['steipete'] },
  ...
  { slug: 'austria', code: 'AT', name: 'Austria', queries: ['location:Austria repos:>5', 'location:Vienna repos:>5', 'location:Wien repos:>5'], locationTerms: ['Austria', 'Österreich', 'Vienna', 'Wien'], seedLogins: ['steipete'] },
