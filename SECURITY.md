...
Replace this section with the supported versions for `ossrank`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `ossrank` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in ossrank.
